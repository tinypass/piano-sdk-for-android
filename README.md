...
dependencies {
    ...
    compile 'io.piano.android:api:1.2.0'

    compile 'io.piano.android:composer:1.2.0'

    compile 'io.piano.android:composer-show-template:1.2.0'

    compile 'io.piano.android:oauth:1.2.0'
}
```
