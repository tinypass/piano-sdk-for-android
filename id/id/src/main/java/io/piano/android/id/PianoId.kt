    ...
    companion object {
        ...
        private fun buildClient(
            ...
            val retrofit = Retrofit.Builder()
                ...
                .build()
            return PianoIdClient(retrofit.create(), moshi, aid, consentsDataProvider, endpoint, useCustomHost)
        }
        ...
        fun init(
            ...
            useCustomHost: Boolean = false,
        ): PianoIdClient = init(endpoint.toHttpUrl(), aid, pianoConsents, useCustomHost)
        ...
        fun init(
            ...
            if (client == null) {
                synchronized(this) {
                    if (client == null) {
                        client = buildClient(endpoint, aid, pianoConsents, useCustomHost)
                    }
                }
            }
            return getInstance()
