...
public class PublisherExportApi {

  private ApiInvoker apiInvoker;

  public PublisherExportApi(ApiInvoker apiInvoker) {
   ...
   * @return Boolean
   */
  public Boolean delete(String aid, String exportId) throws ApiException {
    ...
    if (exportId == null) {
       throw new ApiException(400, "Missing the required parameter 'exportId' when calling delete");
    }
    

    // create path and map variables
    String path = "/publisher/export/delete";
   ...
   * @return String
   */
  public String download(String aid, String exportId) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'aid' is set
    if (aid == null) {
       throw new ApiException(400, "Missing the required parameter 'aid' when calling download");
    }
    
    // verify the required parameter 'exportId' is set
    if (exportId == null) {
       throw new ApiException(400, "Missing the required parameter 'exportId' when calling download");
    }
    

    // create path and map variables
    String path = "/publisher/export/download";
   ...
   * @return Export
   */
  public Export get(String aid, String exportId) throws ApiException {
    Object postBody = null;
    ...
    // verify the required parameter 'exportId' is set
    if (exportId == null) {
       throw new ApiException(400, "Missing the required parameter 'exportId' when calling get");
    }
    

    // create path and map variables
    String path = "/publisher/export/get";
   ...
   * @return List<Export>
   */
  public List<Export> list(String aid, Integer offset, Integer limit, String q, String orderBy, String orderDirection) throws ApiException {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/publisher/export/list";
    ...
    try {
      String response = apiInvoker.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, contentType);
      if(response != null){
        return (List<Export>) ApiInvoker.deserialize(response, "array", Export.class);
      }
      else {
        return null;
      }
   ...
   * @return Boolean
   */
  public Boolean runAgain(String aid, String exportId) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'aid' is set
    if (aid == null) {
       throw new ApiException(400, "Missing the required parameter 'aid' when calling runAgain");
    }
    
    // verify the required parameter 'exportId' is set
    if (exportId == null) {
       throw new ApiException(400, "Missing the required parameter 'exportId' when calling runAgain");
    }
    

    // create path and map variables
    String path = "/publisher/export/run";
